...
namespace HuggingFace
{
    ...
    public sealed partial class GetKernelsRevisionResponseAuthorDataVariant2
    {
        ...
        public global::HuggingFace.GetKernelsRevisionResponseAuthorDataVariant2PrimaryOrg? PrimaryOrg { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetKernelsRevisionResponseAuthorDataVariant2" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetKernelsRevisionResponseAuthorDataVariant2(
            string id,
            string avatarUrl,
            string fullname,
            string name,
            ...
            global::HuggingFace.GetKernelsRevisionResponseAuthorDataVariant2PrimaryOrg? primaryOrg,
            string type = "user")
        {
