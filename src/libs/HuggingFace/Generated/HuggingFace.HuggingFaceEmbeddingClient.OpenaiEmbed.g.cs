...
namespace HuggingFace
{
    public partial class HuggingFaceEmbeddingClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_OpenaiEmbedSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_OpenaiEmbedSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_OpenaiEmbedSecurityRequirement0,
            };
        ...
        {
            var __response = await OpenaiEmbedAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.OpenAICompatResponse>> OpenaiEmbedAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenaiEmbedSecurityRequirements,
                operationName: "OpenaiEmbedAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpenaiEmbed",
                                methodName: "OpenaiEmbedAsync",
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::HuggingFace.ApiException<global::HuggingFace.OpenAICompatErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.OpenAICompatResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.OpenAICompatResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.OpenAICompatResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
