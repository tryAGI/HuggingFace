...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetSpacesByNamespaceByRepoEventsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetSpacesByNamespaceByRepoEventsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetSpacesByNamespaceByRepoEventsSecurityRequirement0,
            };
        partial void PrepareGetSpacesByNamespaceByRepoEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            ref string repo,
            ref string? sessionUuid);
        partial void PrepareGetSpacesByNamespaceByRepoEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            string repo,
            string? sessionUuid);
        partial void ProcessGetSpacesByNamespaceByRepoEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetSpacesByNamespaceByRepoEventsAsync(
            string @namespace,
            string repo,
        ...
        {
            await GetSpacesByNamespaceByRepoEventsAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> GetSpacesByNamespaceByRepoEventsAsResponseAsync(
            string @namespace,
            string repo,
            string? sessionUuid = default,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSpacesByNamespaceByRepoEventsArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSpacesByNamespaceByRepoEventsSecurityRequirements,
                operationName: "GetSpacesByNamespaceByRepoEventsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/spaces/{@namespace}/{repo}/events",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("session_uuid", sessionUuid)
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getSpacesByNamespaceByRepoEvents",
                                methodName: "GetSpacesByNamespaceByRepoEventsAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSpacesByNamespaceByRepoEventsResponse(
                    httpClient: HttpClient,
