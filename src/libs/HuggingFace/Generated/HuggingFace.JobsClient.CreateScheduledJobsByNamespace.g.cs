...
namespace HuggingFace
{
    public partial class JobsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateScheduledJobsByNamespaceSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateScheduledJobsByNamespaceSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateScheduledJobsByNamespaceSecurityRequirement0,
            };
        ...
        partial void ProcessCreateScheduledJobsByNamespaceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateScheduledJobsByNamespaceAsResponseAsync(
                @namespace: @namespace,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateScheduledJobsResponse>> CreateScheduledJobsByNamespaceAsResponseAsync(
            string @namespace,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateScheduledJobsByNamespaceArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateScheduledJobsByNamespaceSecurityRequirements,
                operationName: "CreateScheduledJobsByNamespaceAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createScheduledJobsByNamespace",
                                methodName: "CreateScheduledJobsByNamespaceAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateScheduledJobsByNamespaceResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateScheduledJobsByNamespaceResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateScheduledJobsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateScheduledJobsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateScheduledJobsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.CreateScheduledJobsResponse> CreateScheduledJobsByNamespaceAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreateScheduledJobsRequest
            {
                JobSpec = jobSpec,
                Schedule = schedule,
                Suspend = suspend,
            ...
            return await CreateScheduledJobsByNamespaceAsync(
                @namespace: @namespace,
                request: __request,
                requestOptions: requestOptions,
