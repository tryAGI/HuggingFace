...
namespace HuggingFace
{
    ...
    public sealed partial class GetDiscussionsResponseVariant2EventVariant6AuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDiscussionsResponseVariant2EventVariant6AuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public GetDiscussionsResponseVariant2EventVariant6AuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
