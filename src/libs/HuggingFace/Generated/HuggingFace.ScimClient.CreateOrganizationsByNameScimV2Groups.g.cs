...
namespace HuggingFace
{
    public partial class ScimClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateOrganizationsByNameScimV2GroupsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateOrganizationsByNameScimV2GroupsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateOrganizationsByNameScimV2GroupsSecurityRequirement0,
            };
        ...
        {
            var __response = await CreateOrganizationsByNameScimV2GroupsAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateOrganizationsScimV2GroupsResponse>> CreateOrganizationsByNameScimV2GroupsAsResponseAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrganizationsByNameScimV2GroupsSecurityRequirements,
                operationName: "CreateOrganizationsByNameScimV2GroupsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createOrganizationsByNameScimV2Groups",
                                methodName: "CreateOrganizationsByNameScimV2GroupsAsync",
                                pathTemplate: "$\"/api/organizations/{name}/scim/v2/Groups\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateOrganizationsScimV2GroupsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateOrganizationsScimV2GroupsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateOrganizationsScimV2GroupsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
