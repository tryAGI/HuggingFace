...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        partial void PrepareCreateDatasetsByNamespaceByRepoCommitByRevArguments(
            ...
            object? createPr,
            object? hotReload,
            ref global::HuggingFace.CreateDatasetsCommitContentType? contentType);
        partial void PrepareCreateDatasetsByNamespaceByRepoCommitByRevRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            object? createPr,
            object? hotReload,
            global::HuggingFace.CreateDatasetsCommitContentType? contentType);
        partial void ProcessCreateDatasetsByNamespaceByRepoCommitByRevResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateDatasetsByNamespaceByRepoCommitByRevResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.CreateDatasetsCommitResponse> CreateDatasetsByNamespaceByRepoCommitByRevAsync(
            string @namespace,
            string repo,
            string rev,
        ...
        {
            var __response = await CreateDatasetsByNamespaceByRepoCommitByRevAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                createPr: createPr,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDatasetsCommitResponse>> CreateDatasetsByNamespaceByRepoCommitByRevAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            object? createPr = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDatasetsByNamespaceByRepoCommitByRevArguments(
            ...
            if (contentType != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDatasetsByNamespaceByRepoCommitByRevRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createDatasetsByNamespaceByRepoCommitByRev",
                                methodName: "CreateDatasetsByNamespaceByRepoCommitByRevAsync",
                                pathTemplate: "$\"/api/datasets/{@namespace}/{repo}/commit/{rev}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDatasetsByNamespaceByRepoCommitByRevResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateDatasetsByNamespaceByRepoCommitByRevResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateDatasetsCommitResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDatasetsCommitResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateDatasetsCommitResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
