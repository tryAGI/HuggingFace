...
namespace HuggingFace
{
    public partial class InferenceEndpointsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateInferenceEndpointsByNamespaceAuthCheckByPermsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateInferenceEndpointsByNamespaceAuthCheckByPermsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateInferenceEndpointsByNamespaceAuthCheckByPermsSecurityRequirement0,
            };
        partial void PrepareCreateInferenceEndpointsByNamespaceAuthCheckByPermsArguments(
        ...
        partial void ProcessCreateInferenceEndpointsByNamespaceAuthCheckByPermsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateInferenceEndpointsByNamespaceAuthCheckByPermsAsResponseAsync(
                @namespace: @namespace,
                perms: perms,
                own: own,
                isCreator: isCreator,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateInferenceEndpointsByNamespaceAuthCheckByPermsArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateInferenceEndpointsByNamespaceAuthCheckByPermsSecurityRequirements,
                operationName: "CreateInferenceEndpointsByNamespaceAuthCheckByPermsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateInferenceEndpointsByNamespaceAuthCheckByPermsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createInferenceEndpointsByNamespaceAuthCheckByPerms",
                                methodName: "CreateInferenceEndpointsByNamespaceAuthCheckByPermsAsync",
                                pathTemplate: "$\"/api/inference-endpoints/{@namespace}/auth-check/{(global::System.Uri.EscapeDataString(perms.ToValueString()))}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateInferenceEndpointsByNamespaceAuthCheckByPermsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateInferenceEndpointsByNamespaceAuthCheckByPermsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateInferenceEndpointsAuthCheckResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateInferenceEndpointsAuthCheckResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateInferenceEndpointsAuthCheckResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
