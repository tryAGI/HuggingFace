...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateDatasetsByNamespaceByRepoPreuploadByRevSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateDatasetsByNamespaceByRepoPreuploadByRevSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateDatasetsByNamespaceByRepoPreuploadByRevSecurityRequirement0,
            };
        ...
        {
            var __response = await CreateDatasetsByNamespaceByRepoPreuploadByRevAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDatasetsPreuploadResponse>> CreateDatasetsByNamespaceByRepoPreuploadByRevAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDatasetsByNamespaceByRepoPreuploadByRevSecurityRequirements,
                operationName: "CreateDatasetsByNamespaceByRepoPreuploadByRevAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createDatasetsByNamespaceByRepoPreuploadByRev",
                                methodName: "CreateDatasetsByNamespaceByRepoPreuploadByRevAsync",
                                pathTemplate: "$\"/api/datasets/{@namespace}/{repo}/preupload/{rev}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateDatasetsPreuploadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDatasetsPreuploadResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateDatasetsPreuploadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
