...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateSpacesByNamespaceByRepoLfsFilesBatchSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateSpacesByNamespaceByRepoLfsFilesBatchSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateSpacesByNamespaceByRepoLfsFilesBatchSecurityRequirement0,
            };
        partial void PrepareCreateSpacesByNamespaceByRepoLfsFilesBatchArguments(
        ...
        {
            await CreateSpacesByNamespaceByRepoLfsFilesBatchAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateSpacesByNamespaceByRepoLfsFilesBatchAsResponseAsync(
            string @namespace,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSpacesByNamespaceByRepoLfsFilesBatchArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSpacesByNamespaceByRepoLfsFilesBatchSecurityRequirements,
                operationName: "CreateSpacesByNamespaceByRepoLfsFilesBatchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSpacesByNamespaceByRepoLfsFilesBatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSpacesByNamespaceByRepoLfsFilesBatch",
                                methodName: "CreateSpacesByNamespaceByRepoLfsFilesBatchAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/lfs-files/batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSpacesByNamespaceByRepoLfsFilesBatchResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await CreateSpacesByNamespaceByRepoLfsFilesBatchAsync(
                @namespace: @namespace,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
