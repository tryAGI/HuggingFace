...
namespace HuggingFace
{
    public partial class CollectionsClient
    {
        ...
        {
            await CreateCollectionsByNamespaceBySlugItemsBatchAsResponseAsync(
                @namespace: @namespace,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateCollectionsByNamespaceBySlugItemsBatchAsResponseAsync(
            string @namespace,
            string slug,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createCollectionsByNamespaceBySlugItemsBatch",
                                methodName: "CreateCollectionsByNamespaceBySlugItemsBatchAsync",
                                pathTemplate: "$\"/api/collections/{@namespace}/{slug}/items/batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
