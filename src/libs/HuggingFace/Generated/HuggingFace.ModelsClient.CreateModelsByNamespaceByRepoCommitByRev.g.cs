...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateModelsByNamespaceByRepoCommitByRevSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateModelsByNamespaceByRepoCommitByRevSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateModelsByNamespaceByRepoCommitByRevSecurityRequirement0,
            };
        partial void PrepareCreateModelsByNamespaceByRepoCommitByRevArguments(
        ...
        partial void ProcessCreateModelsByNamespaceByRepoCommitByRevResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateModelsByNamespaceByRepoCommitByRevAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                createPr: createPr,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateModelsCommitResponse>> CreateModelsByNamespaceByRepoCommitByRevAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            object? createPr = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateModelsByNamespaceByRepoCommitByRevArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateModelsByNamespaceByRepoCommitByRevSecurityRequirements,
                operationName: "CreateModelsByNamespaceByRepoCommitByRevAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/models/{@namespace}/{repo}/commit/{rev}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createModelsByNamespaceByRepoCommitByRev",
                                methodName: "CreateModelsByNamespaceByRepoCommitByRevAsync",
                                pathTemplate: "$\"/api/models/{@namespace}/{repo}/commit/{rev}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateModelsByNamespaceByRepoCommitByRevResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateModelsByNamespaceByRepoCommitByRevResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateModelsCommitResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateModelsCommitResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateModelsCommitResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
