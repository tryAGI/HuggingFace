...
namespace HuggingFace
{
    public partial class JobsClient
    {
        ...
        partial void PrepareGetJobsByNamespaceByJobIdEventsArguments(
            ...
            ref string jobId);
        partial void PrepareGetJobsByNamespaceByJobIdEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            string jobId);
        partial void ProcessGetJobsByNamespaceByJobIdEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetJobsByNamespaceByJobIdEventsAsync(
            string @namespace,
            string jobId,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await GetJobsByNamespaceByJobIdEventsAsResponseAsync(
                @namespace: @namespace,
                jobId: jobId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> GetJobsByNamespaceByJobIdEventsAsResponseAsync(
            string @namespace,
            string jobId,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetJobsByNamespaceByJobIdEventsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetJobsByNamespaceByJobIdEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getJobsByNamespaceByJobIdEvents",
                                methodName: "GetJobsByNamespaceByJobIdEventsAsync",
                                pathTemplate: "$\"/api/jobs/{@namespace}/{jobId}/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetJobsByNamespaceByJobIdEventsResponse(
                    httpClient: HttpClient,
