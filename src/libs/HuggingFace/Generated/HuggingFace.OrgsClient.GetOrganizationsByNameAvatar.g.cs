...
namespace HuggingFace
{
    public partial class OrgsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetOrganizationsByNameAvatarSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetOrganizationsByNameAvatarSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetOrganizationsByNameAvatarSecurityRequirement0,
            };
        ...
        partial void ProcessGetOrganizationsByNameAvatarResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetOrganizationsByNameAvatarAsResponseAsync(
                name: name,
                redirect: redirect,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrganizationsByNameAvatarSecurityRequirements,
                operationName: "GetOrganizationsByNameAvatarAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getOrganizationsByNameAvatar",
                                methodName: "GetOrganizationsByNameAvatarAsync",
                                pathTemplate: "$\"/api/organizations/{name}/avatar\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrganizationsByNameAvatarResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrganizationsByNameAvatarResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetOrganizationsAvatarResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetOrganizationsAvatarResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetOrganizationsAvatarResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
