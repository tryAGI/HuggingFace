...
namespace HuggingFace
{
    ...
    public sealed partial class CreateOrganizationsScimProvisioningV2UsersResponseName
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrganizationsScimProvisioningV2UsersResponseName" /> class.
        /// </summary>
...
#endif
        public CreateOrganizationsScimProvisioningV2UsersResponseName(
            string givenName,
            string familyName,
            string formatted)
        {
