...
namespace HuggingFace
{
    ...
    public sealed partial class CreateBlogCommentReplyResponseNewMessageAuthorOauthAppImageData2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBlogCommentReplyResponseNewMessageAuthorOauthAppImageData2" /> class.
        /// </summary>
...
#endif
        public CreateBlogCommentReplyResponseNewMessageAuthorOauthAppImageData2(
            string emoji,
            string colorFrom,
            string colorTo)
        {
