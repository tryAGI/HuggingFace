...
namespace HuggingFace
{
    ...
    public sealed partial class GetDiscussionsResponseVariant2EventVariant1AuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDiscussionsResponseVariant2EventVariant1AuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public GetDiscussionsResponseVariant2EventVariant1AuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
