...
namespace HuggingFace
{
    ...
    public sealed partial class CreatePapersCommentResponseNewMessageAuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePapersCommentResponseNewMessageAuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreatePapersCommentResponseNewMessageAuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
