...
namespace HuggingFace
{
    public partial class CollectionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_EditCollectionsByNamespaceBySlugSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_EditCollectionsByNamespaceBySlugSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_EditCollectionsByNamespaceBySlugSecurityRequirement0,
            };
        partial void PrepareEditCollectionsByNamespaceBySlugArguments(
        ...
        partial void ProcessEditCollectionsByNamespaceBySlugResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await EditCollectionsByNamespaceBySlugAsResponseAsync(
                @namespace: @namespace,
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.PatchCollectionsResponse2>> EditCollectionsByNamespaceBySlugAsResponseAsync(
            string @namespace,
            string slug,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditCollectionsByNamespaceBySlugArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditCollectionsByNamespaceBySlugSecurityRequirements,
                operationName: "EditCollectionsByNamespaceBySlugAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditCollectionsByNamespaceBySlugRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editCollectionsByNamespaceBySlug",
                                methodName: "EditCollectionsByNamespaceBySlugAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditCollectionsByNamespaceBySlugResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEditCollectionsByNamespaceBySlugResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.PatchCollectionsResponse2.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.PatchCollectionsResponse2>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.PatchCollectionsResponse2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await EditCollectionsByNamespaceBySlugAsync(
                @namespace: @namespace,
                slug: slug,
                request: __request,
                requestOptions: requestOptions,
