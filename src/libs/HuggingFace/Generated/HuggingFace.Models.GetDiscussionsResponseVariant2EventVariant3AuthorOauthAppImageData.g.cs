...
namespace HuggingFace
{
    ...
    public sealed partial class GetDiscussionsResponseVariant2EventVariant3AuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDiscussionsResponseVariant2EventVariant3AuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public GetDiscussionsResponseVariant2EventVariant3AuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
