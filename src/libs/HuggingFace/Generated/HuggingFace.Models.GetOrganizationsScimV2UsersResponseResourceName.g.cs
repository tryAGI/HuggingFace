...
namespace HuggingFace
{
    ...
    public sealed partial class GetOrganizationsScimV2UsersResponseResourceName
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationsScimV2UsersResponseResourceName" /> class.
        /// </summary>
...
#endif
        public GetOrganizationsScimV2UsersResponseResourceName(
            string givenName,
            string familyName,
            string formatted)
        {
