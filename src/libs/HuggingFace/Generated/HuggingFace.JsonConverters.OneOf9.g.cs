...
{
    /// <inheritdoc />
    public class OneOfJsonConverter<T1, T2, T3, T4, T5, T6, T7, T8, T9> : global::System.Text.Json.Serialization.JsonConverter<global::HuggingFace.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9>>
    {
        /// <inheritdoc />
        public override global::HuggingFace.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __value = new global::HuggingFace.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
                value1,
        ...
        public override void Write(
            ...
            global::HuggingFace.OneOf<T1, T2, T3, T4, T5, T6, T7, T8, T9> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
