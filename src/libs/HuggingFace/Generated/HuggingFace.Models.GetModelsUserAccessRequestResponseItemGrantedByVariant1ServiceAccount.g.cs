...
namespace HuggingFace
{
    ...
    public sealed partial class GetModelsUserAccessRequestResponseItemGrantedByVariant1ServiceAccount
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetModelsUserAccessRequestResponseItemGrantedByVariant1ServiceAccount" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetModelsUserAccessRequestResponseItemGrantedByVariant1ServiceAccount(
            string id,
            string org,
            string orgAvatarUrl,
            string? description)
