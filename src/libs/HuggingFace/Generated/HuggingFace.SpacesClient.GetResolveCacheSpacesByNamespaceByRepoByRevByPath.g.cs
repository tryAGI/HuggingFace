...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetResolveCacheSpacesByNamespaceByRepoByRevByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetResolveCacheSpacesByNamespaceByRepoByRevByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetResolveCacheSpacesByNamespaceByRepoByRevByPathSecurityRequirement0,
            };
        partial void PrepareGetResolveCacheSpacesByNamespaceByRepoByRevByPathArguments(
            ...
            ref string? range,
            ref string? accept);
        partial void PrepareGetResolveCacheSpacesByNamespaceByRepoByRevByPathRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? range,
            string? accept);
        partial void ProcessGetResolveCacheSpacesByNamespaceByRepoByRevByPathResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetResolveCacheSpacesByNamespaceByRepoByRevByPathResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetResolveCacheSpacesByNamespaceByRepoByRevByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveCacheSpacesResponse>> GetResolveCacheSpacesByNamespaceByRepoByRevByPathAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetResolveCacheSpacesByNamespaceByRepoByRevByPathArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetResolveCacheSpacesByNamespaceByRepoByRevByPathSecurityRequirements,
                operationName: "GetResolveCacheSpacesByNamespaceByRepoByRevByPathAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/resolve-cache/spaces/{@namespace}/{repo}/{rev}/{path}",
            ...
            if (accept != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetResolveCacheSpacesByNamespaceByRepoByRevByPathRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getResolveCacheSpacesByNamespaceByRepoByRevByPath",
                                methodName: "GetResolveCacheSpacesByNamespaceByRepoByRevByPathAsync",
                                pathTemplate: "$\"/api/resolve-cache/spaces/{@namespace}/{repo}/{rev}/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetResolveCacheSpacesByNamespaceByRepoByRevByPathResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetResolveCacheSpacesByNamespaceByRepoByRevByPathResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetResolveCacheSpacesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveCacheSpacesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetResolveCacheSpacesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
