...
namespace HuggingFace
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateSettingsWebhooksByWebhookIdSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateSettingsWebhooksByWebhookIdSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateSettingsWebhooksByWebhookIdSecurityRequirement0,
            };
        ...
        partial void ProcessCreateSettingsWebhooksByWebhookIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateSettingsWebhooksByWebhookIdAsResponseAsync(
                webhookId: webhookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateSettingsWebhooksResponse2>> CreateSettingsWebhooksByWebhookIdAsResponseAsync(
            string webhookId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSettingsWebhooksByWebhookIdArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSettingsWebhooksByWebhookIdSecurityRequirements,
                operationName: "CreateSettingsWebhooksByWebhookIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSettingsWebhooksByWebhookIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSettingsWebhooksByWebhookId",
                                methodName: "CreateSettingsWebhooksByWebhookIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSettingsWebhooksByWebhookIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateSettingsWebhooksByWebhookIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateSettingsWebhooksResponse2.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateSettingsWebhooksResponse2>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateSettingsWebhooksResponse2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateSettingsWebhooksByWebhookIdAsync(
                webhookId: webhookId,
                request: __request,
                requestOptions: requestOptions,
