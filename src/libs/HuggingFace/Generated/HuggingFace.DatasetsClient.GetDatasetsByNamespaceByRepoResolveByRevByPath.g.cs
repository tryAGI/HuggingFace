...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetDatasetsByNamespaceByRepoResolveByRevByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetDatasetsByNamespaceByRepoResolveByRevByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetDatasetsByNamespaceByRepoResolveByRevByPathSecurityRequirement0,
            };
        partial void PrepareGetDatasetsByNamespaceByRepoResolveByRevByPathArguments(
            ...
            ref string? range,
            ref string? accept);
        partial void PrepareGetDatasetsByNamespaceByRepoResolveByRevByPathRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? range,
            string? accept);
        partial void ProcessGetDatasetsByNamespaceByRepoResolveByRevByPathResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDatasetsByNamespaceByRepoResolveByRevByPathResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.GetDatasetsResolveResponse> GetDatasetsByNamespaceByRepoResolveByRevByPathAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
        ...
        {
            var __response = await GetDatasetsByNamespaceByRepoResolveByRevByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetDatasetsResolveResponse>> GetDatasetsByNamespaceByRepoResolveByRevByPathAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDatasetsByNamespaceByRepoResolveByRevByPathArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDatasetsByNamespaceByRepoResolveByRevByPathSecurityRequirements,
                operationName: "GetDatasetsByNamespaceByRepoResolveByRevByPathAsync");
            ...
            if (accept != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDatasetsByNamespaceByRepoResolveByRevByPathRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDatasetsByNamespaceByRepoResolveByRevByPath",
                                methodName: "GetDatasetsByNamespaceByRepoResolveByRevByPathAsync",
                                pathTemplate: "$\"/datasets/{@namespace}/{repo}/resolve/{rev}/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDatasetsByNamespaceByRepoResolveByRevByPathResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDatasetsByNamespaceByRepoResolveByRevByPathResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetDatasetsResolveResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetDatasetsResolveResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetDatasetsResolveResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
