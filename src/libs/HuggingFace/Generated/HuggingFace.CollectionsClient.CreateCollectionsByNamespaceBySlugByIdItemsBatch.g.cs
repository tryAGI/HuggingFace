...
namespace HuggingFace
{
    public partial class CollectionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateCollectionsByNamespaceBySlugByIdItemsBatchSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateCollectionsByNamespaceBySlugByIdItemsBatchSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateCollectionsByNamespaceBySlugByIdItemsBatchSecurityRequirement0,
            };
        partial void PrepareCreateCollectionsByNamespaceBySlugByIdItemsBatchArguments(
        ...
        public async global::System.Threading.Tasks.Task CreateCollectionsByNamespaceBySlugByIdItemsBatchAsync(
            string @namespace,
            string slug,
            string id,
        ...
        {
            await CreateCollectionsByNamespaceBySlugByIdItemsBatchAsResponseAsync(
                @namespace: @namespace,
                slug: slug,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateCollectionsByNamespaceBySlugByIdItemsBatchAsResponseAsync(
            string @namespace,
            string slug,
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateCollectionsByNamespaceBySlugByIdItemsBatchArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateCollectionsByNamespaceBySlugByIdItemsBatchSecurityRequirements,
                operationName: "CreateCollectionsByNamespaceBySlugByIdItemsBatchAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/collections/{@namespace}/{slug}-{id}/items/batch",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateCollectionsByNamespaceBySlugByIdItemsBatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createCollectionsByNamespaceBySlugByIdItemsBatch",
                                methodName: "CreateCollectionsByNamespaceBySlugByIdItemsBatchAsync",
                                pathTemplate: "$\"/api/collections/{@namespace}/{slug}-{id}/items/batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateCollectionsByNamespaceBySlugByIdItemsBatchResponse(
                    httpClient: HttpClient,
