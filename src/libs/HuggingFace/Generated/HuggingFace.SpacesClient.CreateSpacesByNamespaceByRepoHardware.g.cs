...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateSpacesByNamespaceByRepoHardwareSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateSpacesByNamespaceByRepoHardwareSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateSpacesByNamespaceByRepoHardwareSecurityRequirement0,
            };
        partial void PrepareCreateSpacesByNamespaceByRepoHardwareArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            ref string repo,
            global::HuggingFace.CreateSpacesHardwareRequest request);
        partial void PrepareCreateSpacesByNamespaceByRepoHardwareRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            string repo,
            global::HuggingFace.CreateSpacesHardwareRequest request);
        partial void ProcessCreateSpacesByNamespaceByRepoHardwareResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateSpacesByNamespaceByRepoHardwareAsync(
            string @namespace,
            string repo,
        ...
        {
            await CreateSpacesByNamespaceByRepoHardwareAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateSpacesByNamespaceByRepoHardwareAsResponseAsync(
            string @namespace,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSpacesByNamespaceByRepoHardwareArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSpacesByNamespaceByRepoHardwareSecurityRequirements,
                operationName: "CreateSpacesByNamespaceByRepoHardwareAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/spaces/{@namespace}/{repo}/hardware",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSpacesByNamespaceByRepoHardwareRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSpacesByNamespaceByRepoHardware",
                                methodName: "CreateSpacesByNamespaceByRepoHardwareAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/hardware\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSpacesByNamespaceByRepoHardwareResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateSpacesByNamespaceByRepoHardwareAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreateSpacesHardwareRequest
            {
                Flavor = flavor,
                SleepTimeSeconds = sleepTimeSeconds,
            };

            await CreateSpacesByNamespaceByRepoHardwareAsync(
                @namespace: @namespace,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
