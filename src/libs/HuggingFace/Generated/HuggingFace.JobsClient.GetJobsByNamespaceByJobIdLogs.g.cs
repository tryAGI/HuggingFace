...
namespace HuggingFace
{
    public partial class JobsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetJobsByNamespaceByJobIdLogsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetJobsByNamespaceByJobIdLogsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetJobsByNamespaceByJobIdLogsSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetJobsByNamespaceByJobIdLogsSecurityRequirements,
                operationName: "GetJobsByNamespaceByJobIdLogsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetJobsByNamespaceByJobIdLogsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getJobsByNamespaceByJobIdLogs",
                                methodName: "GetJobsByNamespaceByJobIdLogsAsync",
                                pathTemplate: "$\"/api/jobs/{@namespace}/{jobId}/logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetJobsByNamespaceByJobIdLogsResponse(
                    httpClient: HttpClient,
