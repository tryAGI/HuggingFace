...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_DeleteSpacesByNamespaceByRepoLfsFilesByShaSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_DeleteSpacesByNamespaceByRepoLfsFilesByShaSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_DeleteSpacesByNamespaceByRepoLfsFilesByShaSecurityRequirement0,
            };
        partial void PrepareDeleteSpacesByNamespaceByRepoLfsFilesByShaArguments(
        ...
        public async global::System.Threading.Tasks.Task DeleteSpacesByNamespaceByRepoLfsFilesByShaAsync(
            string @namespace,
            string repo,
            string sha,
        ...
        {
            await DeleteSpacesByNamespaceByRepoLfsFilesByShaAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                sha: sha,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> DeleteSpacesByNamespaceByRepoLfsFilesByShaAsResponseAsync(
            string @namespace,
            string repo,
            string sha,
            object? rewriteHistory = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteSpacesByNamespaceByRepoLfsFilesByShaArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteSpacesByNamespaceByRepoLfsFilesByShaSecurityRequirements,
                operationName: "DeleteSpacesByNamespaceByRepoLfsFilesByShaAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteSpacesByNamespaceByRepoLfsFilesByShaRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteSpacesByNamespaceByRepoLfsFilesBySha",
                                methodName: "DeleteSpacesByNamespaceByRepoLfsFilesByShaAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/lfs-files/{sha}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteSpacesByNamespaceByRepoLfsFilesByShaResponse(
                    httpClient: HttpClient,
