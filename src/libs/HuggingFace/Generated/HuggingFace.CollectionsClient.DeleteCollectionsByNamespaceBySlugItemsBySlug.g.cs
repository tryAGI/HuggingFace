...
namespace HuggingFace
{
    public partial class CollectionsClient
    {
        ...
        {
            await DeleteCollectionsByNamespaceBySlugItemsBySlugAsResponseAsync(
                @namespace: @namespace,
                slug: slug,
                slug2: slug2,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> DeleteCollectionsByNamespaceBySlugItemsBySlugAsResponseAsync(
            string @namespace,
            string slug,
            string slug2,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "deleteCollectionsByNamespaceBySlugItemsBySlug",
                                methodName: "DeleteCollectionsByNamespaceBySlugItemsBySlugAsync",
