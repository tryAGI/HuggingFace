...
namespace HuggingFace
{
    ...
    public sealed partial class CreatePapersCommentReplyResponseNewMessageAuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePapersCommentReplyResponseNewMessageAuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreatePapersCommentReplyResponseNewMessageAuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
