...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetDatasetsByNamespaceByRepoJwtSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetDatasetsByNamespaceByRepoJwtSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetDatasetsByNamespaceByRepoJwtSecurityRequirement0,
            };
        partial void PrepareGetDatasetsByNamespaceByRepoJwtArguments(
        ...
        partial void PrepareGetDatasetsByNamespaceByRepoJwtRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            object? includeProStatus,
            object? billingDetails);
        partial void ProcessGetDatasetsByNamespaceByRepoJwtResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDatasetsByNamespaceByRepoJwtResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.GetDatasetsJwtResponse> GetDatasetsByNamespaceByRepoJwtAsync(
            string @namespace,
            string repo,
        ...
        {
            var __response = await GetDatasetsByNamespaceByRepoJwtAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                write: write,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetDatasetsJwtResponse>> GetDatasetsByNamespaceByRepoJwtAsResponseAsync(
            string @namespace,
            string repo,
            object? write = default,
            global::System.DateTime? expiration = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDatasetsByNamespaceByRepoJwtArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDatasetsByNamespaceByRepoJwtSecurityRequirements,
                operationName: "GetDatasetsByNamespaceByRepoJwtAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDatasetsByNamespaceByRepoJwt",
                                methodName: "GetDatasetsByNamespaceByRepoJwtAsync",
                                pathTemplate: "$\"/api/datasets/{@namespace}/{repo}/jwt\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDatasetsByNamespaceByRepoJwtResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDatasetsByNamespaceByRepoJwtResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetDatasetsJwtResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetDatasetsJwtResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetDatasetsJwtResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
