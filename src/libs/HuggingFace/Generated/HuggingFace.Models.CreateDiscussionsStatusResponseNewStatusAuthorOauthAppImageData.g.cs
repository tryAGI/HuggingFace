...
namespace HuggingFace
{
    ...
    public sealed partial class CreateDiscussionsStatusResponseNewStatusAuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDiscussionsStatusResponseNewStatusAuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreateDiscussionsStatusResponseNewStatusAuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
