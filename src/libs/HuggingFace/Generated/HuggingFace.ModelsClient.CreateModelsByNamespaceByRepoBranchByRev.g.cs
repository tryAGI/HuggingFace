...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateModelsByNamespaceByRepoBranchByRevSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateModelsByNamespaceByRepoBranchByRevSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateModelsByNamespaceByRepoBranchByRevSecurityRequirement0,
            };
        partial void PrepareCreateModelsByNamespaceByRepoBranchByRevArguments(
        ...
        public async global::System.Threading.Tasks.Task CreateModelsByNamespaceByRepoBranchByRevAsync(
            string @namespace,
            string repo,
            string rev,
        ...
        {
            await CreateModelsByNamespaceByRepoBranchByRevAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateModelsByNamespaceByRepoBranchByRevAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateModelsByNamespaceByRepoBranchByRevArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateModelsByNamespaceByRepoBranchByRevSecurityRequirements,
                operationName: "CreateModelsByNamespaceByRepoBranchByRevAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createModelsByNamespaceByRepoBranchByRev",
                                methodName: "CreateModelsByNamespaceByRepoBranchByRevAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateModelsByNamespaceByRepoBranchByRevResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await CreateModelsByNamespaceByRepoBranchByRevAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                request: __request,
