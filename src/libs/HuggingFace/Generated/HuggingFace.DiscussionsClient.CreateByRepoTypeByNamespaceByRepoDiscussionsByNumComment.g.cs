...
namespace HuggingFace
{
    public partial class DiscussionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentSecurityRequirement0,
            };
        ...
        partial void ProcessCreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentAsResponseAsync(
                repoType: repoType,
                @namespace: @namespace,
                repo: repo,
                num: num,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDiscussionsCommentResponse>> CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentAsResponseAsync(
            global::HuggingFace.CreateDiscussionsCommentRepoType repoType,
            string @namespace,
            string repo,
            string num,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentSecurityRequirements,
                operationName: "CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateDiscussionsCommentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDiscussionsCommentResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateDiscussionsCommentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentAsync(
                repoType: repoType,
                @namespace: @namespace,
                repo: repo,
                num: num,
