...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        {
            await CreateModelsByNamespaceByRepoUserAccessRequestCancelAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateModelsByNamespaceByRepoUserAccessRequestCancelAsResponseAsync(
            string @namespace,
            string repo,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createModelsByNamespaceByRepoUserAccessRequestCancel",
                                methodName: "CreateModelsByNamespaceByRepoUserAccessRequestCancelAsync",
                                pathTemplate: "$\"/api/models/{@namespace}/{repo}/user-access-request/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
