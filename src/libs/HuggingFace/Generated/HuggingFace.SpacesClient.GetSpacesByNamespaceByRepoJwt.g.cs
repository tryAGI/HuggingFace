...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetSpacesByNamespaceByRepoJwtSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetSpacesByNamespaceByRepoJwtSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetSpacesByNamespaceByRepoJwtSecurityRequirement0,
            };
        ...
        {
            var __response = await GetSpacesByNamespaceByRepoJwtAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                write: write,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetSpacesJwtResponse>> GetSpacesByNamespaceByRepoJwtAsResponseAsync(
            string @namespace,
            string repo,
            object? write = default,
            global::System.DateTime? expiration = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSpacesByNamespaceByRepoJwtSecurityRequirements,
                operationName: "GetSpacesByNamespaceByRepoJwtAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getSpacesByNamespaceByRepoJwt",
                                methodName: "GetSpacesByNamespaceByRepoJwtAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/jwt\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetSpacesJwtResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetSpacesJwtResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetSpacesJwtResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
