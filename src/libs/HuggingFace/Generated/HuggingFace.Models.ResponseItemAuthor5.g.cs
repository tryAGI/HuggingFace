...
namespace HuggingFace
{
    ...
    public sealed partial class ResponseItemAuthor5
    {
        ...
        public global::HuggingFace.ResponseItemAuthorUser? User { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseItemAuthor5" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public ResponseItemAuthor5(
            string id,
            string name,
            bool hidden,
            string? status,
            global::System.DateTime? statusLastChangedAt,
            global::HuggingFace.ResponseItemAuthorUser? user)
        {
