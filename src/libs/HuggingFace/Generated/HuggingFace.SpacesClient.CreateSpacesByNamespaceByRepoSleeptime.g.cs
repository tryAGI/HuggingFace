...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateSpacesByNamespaceByRepoSleeptimeSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateSpacesByNamespaceByRepoSleeptimeSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateSpacesByNamespaceByRepoSleeptimeSecurityRequirement0,
            };
        partial void PrepareCreateSpacesByNamespaceByRepoSleeptimeArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            ref string repo,
            global::HuggingFace.CreateSpacesSleeptimeRequest request);
        partial void PrepareCreateSpacesByNamespaceByRepoSleeptimeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            string repo,
            global::HuggingFace.CreateSpacesSleeptimeRequest request);
        partial void ProcessCreateSpacesByNamespaceByRepoSleeptimeResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            await CreateSpacesByNamespaceByRepoSleeptimeAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateSpacesByNamespaceByRepoSleeptimeAsResponseAsync(
            string @namespace,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSpacesByNamespaceByRepoSleeptimeArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSpacesByNamespaceByRepoSleeptimeSecurityRequirements,
                operationName: "CreateSpacesByNamespaceByRepoSleeptimeAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/spaces/{@namespace}/{repo}/sleeptime",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSpacesByNamespaceByRepoSleeptimeRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSpacesByNamespaceByRepoSleeptime",
                                methodName: "CreateSpacesByNamespaceByRepoSleeptimeAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/sleeptime\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSpacesByNamespaceByRepoSleeptimeResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateSpacesByNamespaceByRepoSleeptimeAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreateSpacesSleeptimeRequest
            {
                Seconds = seconds,
            };

            await CreateSpacesByNamespaceByRepoSleeptimeAsync(
                @namespace: @namespace,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
