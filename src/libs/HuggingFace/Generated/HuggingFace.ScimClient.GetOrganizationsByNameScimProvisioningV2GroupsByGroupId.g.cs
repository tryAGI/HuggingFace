...
namespace HuggingFace
{
    public partial class ScimClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.Response41> GetOrganizationsByNameScimProvisioningV2GroupsByGroupIdAsync(
            string name,
            string groupId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.Response41.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.Response41.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
