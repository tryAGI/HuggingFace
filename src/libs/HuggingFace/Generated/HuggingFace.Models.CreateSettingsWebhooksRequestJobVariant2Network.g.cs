...
namespace HuggingFace
{
    ...
    public sealed partial class CreateSettingsWebhooksRequestJobVariant2Network
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSettingsWebhooksRequestJobVariant2Network" /> class.
        /// </summary>
        /// <param name="group">
        /// Group name, scoped to the job's owner and resource group.
        /// </param>
...
#endif
        public CreateSettingsWebhooksRequestJobVariant2Network(
            string group,
