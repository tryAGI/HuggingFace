...
namespace HuggingFace
{
    public partial class DiscussionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreatePostsByUsernameByPostSlugCommentByCommentIdReplySecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreatePostsByUsernameByPostSlugCommentByCommentIdReplySecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreatePostsByUsernameByPostSlugCommentByCommentIdReplySecurityRequirement0,
            };
        ...
        {
            var __response = await CreatePostsByUsernameByPostSlugCommentByCommentIdReplyAsResponseAsync(
                username: username,
                postSlug: postSlug,
                commentId: commentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreatePostsCommentReplyResponse>> CreatePostsByUsernameByPostSlugCommentByCommentIdReplyAsResponseAsync(
            string username,
            string postSlug,
            string commentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePostsByUsernameByPostSlugCommentByCommentIdReplySecurityRequirements,
                operationName: "CreatePostsByUsernameByPostSlugCommentByCommentIdReplyAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createPostsByUsernameByPostSlugCommentByCommentIdReply",
                                methodName: "CreatePostsByUsernameByPostSlugCommentByCommentIdReplyAsync",
                                pathTemplate: "$\"/api/posts/{username}/{postSlug}/comment/{commentId}/reply\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreatePostsCommentReplyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreatePostsCommentReplyResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreatePostsCommentReplyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
