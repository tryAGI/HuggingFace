...
namespace HuggingFace
{
    public partial class DiscussionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.Response118> CreatePostsByUsernameByPostSlugCommentByCommentIdReplyAsync(
            string username,
            string postSlug,
            string commentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.Response118.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.Response118.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
