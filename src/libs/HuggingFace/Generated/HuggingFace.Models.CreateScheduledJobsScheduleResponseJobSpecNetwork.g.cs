...
namespace HuggingFace
{
    ...
    public sealed partial class CreateScheduledJobsScheduleResponseJobSpecNetwork
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScheduledJobsScheduleResponseJobSpecNetwork" /> class.
        /// </summary>
        /// <param name="group">
        /// Group name, scoped to the job's owner and resource group.
        /// </param>
...
#endif
        public CreateScheduledJobsScheduleResponseJobSpecNetwork(
            string group,
