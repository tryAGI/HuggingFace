...
namespace HuggingFace
{
    public partial class BucketsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetBucketsByNamespaceByRepoResolveByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetBucketsByNamespaceByRepoResolveByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetBucketsByNamespaceByRepoResolveByPathSecurityRequirement0,
            };
        partial void PrepareGetBucketsByNamespaceByRepoResolveByPathArguments(
        ...
        partial void ProcessGetBucketsByNamespaceByRepoResolveByPathResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.GetBucketsResolveResponse> GetBucketsByNamespaceByRepoResolveByPathAsync(
            string @namespace,
            string repo,
            string path,
        ...
        {
            var __response = await GetBucketsByNamespaceByRepoResolveByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetBucketsResolveResponse>> GetBucketsByNamespaceByRepoResolveByPathAsResponseAsync(
            string @namespace,
            string repo,
            string path,
            object? noContentDisposition = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBucketsByNamespaceByRepoResolveByPathArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBucketsByNamespaceByRepoResolveByPathSecurityRequirements,
                operationName: "GetBucketsByNamespaceByRepoResolveByPathAsync");
            ...
            if (accept != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetBucketsByNamespaceByRepoResolveByPathRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getBucketsByNamespaceByRepoResolveByPath",
                                methodName: "GetBucketsByNamespaceByRepoResolveByPathAsync",
                                pathTemplate: "$\"/buckets/{@namespace}/{repo}/resolve/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBucketsByNamespaceByRepoResolveByPathResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::HuggingFace.GetBucketsResolveResponse3? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::HuggingFace.GetBucketsResolveResponse3.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::HuggingFace.ApiException<global::HuggingFace.GetBucketsResolveResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::HuggingFace.GetBucketsResolveResponse4? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::HuggingFace.GetBucketsResolveResponse4.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::HuggingFace.ApiException<global::HuggingFace.GetBucketsResolveResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBucketsByNamespaceByRepoResolveByPathResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetBucketsResolveResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetBucketsResolveResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetBucketsResolveResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
