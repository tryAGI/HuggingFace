...
namespace HuggingFace
{
    public partial class ScimClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_EditOrganizationsByNameScimV2UsersByUserIdSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_EditOrganizationsByNameScimV2UsersByUserIdSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_EditOrganizationsByNameScimV2UsersByUserIdSecurityRequirement0,
            };
        ...
        {
            var __response = await EditOrganizationsByNameScimV2UsersByUserIdAsResponseAsync(
                name: name,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.PatchOrganizationsScimV2UsersResponse>> EditOrganizationsByNameScimV2UsersByUserIdAsResponseAsync(
            string name,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditOrganizationsByNameScimV2UsersByUserIdSecurityRequirements,
                operationName: "EditOrganizationsByNameScimV2UsersByUserIdAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editOrganizationsByNameScimV2UsersByUserId",
                                methodName: "EditOrganizationsByNameScimV2UsersByUserIdAsync",
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.PatchOrganizationsScimV2UsersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.PatchOrganizationsScimV2UsersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.PatchOrganizationsScimV2UsersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
