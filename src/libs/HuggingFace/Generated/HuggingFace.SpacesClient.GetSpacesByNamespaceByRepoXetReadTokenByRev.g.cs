...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.Response84> GetSpacesByNamespaceByRepoXetReadTokenByRevAsync(
            string @namespace,
            string repo,
            string rev,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.Response84.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.Response84.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
