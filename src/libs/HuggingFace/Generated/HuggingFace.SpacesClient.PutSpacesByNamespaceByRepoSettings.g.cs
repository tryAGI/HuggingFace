...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        partial void ProcessPutSpacesByNamespaceByRepoSettingsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await PutSpacesByNamespaceByRepoSettingsAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.PutSpacesSettingsResponse>> PutSpacesByNamespaceByRepoSettingsAsResponseAsync(
            string @namespace,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePutSpacesByNamespaceByRepoSettingsArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePutSpacesByNamespaceByRepoSettingsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "putSpacesByNamespaceByRepoSettings",
                                methodName: "PutSpacesByNamespaceByRepoSettingsAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/settings\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPutSpacesByNamespaceByRepoSettingsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPutSpacesByNamespaceByRepoSettingsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.PutSpacesSettingsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.PutSpacesSettingsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.PutSpacesSettingsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.PutSpacesSettingsResponse> PutSpacesByNamespaceByRepoSettingsAsync(
            ...
            global::HuggingFace.AnyOf<bool?, global::HuggingFace.PutSpacesSettingsRequestGated?>? gated = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PutSpacesByNamespaceByRepoSettingsAsync(
                @namespace: @namespace,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
