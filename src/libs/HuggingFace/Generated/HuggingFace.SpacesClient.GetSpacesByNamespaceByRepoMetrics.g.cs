...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetSpacesByNamespaceByRepoMetricsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetSpacesByNamespaceByRepoMetricsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetSpacesByNamespaceByRepoMetricsSecurityRequirement0,
            };
        partial void PrepareGetSpacesByNamespaceByRepoMetricsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            ref string repo);
        partial void PrepareGetSpacesByNamespaceByRepoMetricsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            string repo);
        partial void ProcessGetSpacesByNamespaceByRepoMetricsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetSpacesByNamespaceByRepoMetricsAsync(
            string @namespace,
            string repo,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await GetSpacesByNamespaceByRepoMetricsAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> GetSpacesByNamespaceByRepoMetricsAsResponseAsync(
            string @namespace,
            string repo,
            global::HuggingFace.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSpacesByNamespaceByRepoMetricsArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSpacesByNamespaceByRepoMetricsSecurityRequirements,
                operationName: "GetSpacesByNamespaceByRepoMetricsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/spaces/{@namespace}/{repo}/metrics",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSpacesByNamespaceByRepoMetricsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getSpacesByNamespaceByRepoMetrics",
                                methodName: "GetSpacesByNamespaceByRepoMetricsAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/metrics\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSpacesByNamespaceByRepoMetricsResponse(
                    httpClient: HttpClient,
