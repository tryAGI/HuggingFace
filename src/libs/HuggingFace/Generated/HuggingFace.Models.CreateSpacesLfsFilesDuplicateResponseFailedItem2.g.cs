...
namespace HuggingFace
{
    ...
    public sealed partial class CreateSpacesLfsFilesDuplicateResponseFailedItem2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSpacesLfsFilesDuplicateResponseFailedItem2" /> class.
        /// </summary>
        /// <param name="xetHash">
        /// Xet content hash of the file that failed
        /// </param>
...
#endif
        public CreateSpacesLfsFilesDuplicateResponseFailedItem2(
            string xetHash,
            string sha256,
            string error)
        {
