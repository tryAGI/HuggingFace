...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateSpacesByNamespaceByRepoBranchByRevSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateSpacesByNamespaceByRepoBranchByRevSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateSpacesByNamespaceByRepoBranchByRevSecurityRequirement0,
            };
        partial void PrepareCreateSpacesByNamespaceByRepoBranchByRevArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            ref string repo,
            ref string rev,
            global::HuggingFace.CreateSpacesBranchRequest request);
        partial void PrepareCreateSpacesByNamespaceByRepoBranchByRevRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string rev,
            global::HuggingFace.CreateSpacesBranchRequest request);
        partial void ProcessCreateSpacesByNamespaceByRepoBranchByRevResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateSpacesByNamespaceByRepoBranchByRevAsync(
            string @namespace,
            string repo,
            string rev,
        ...
        {
            await CreateSpacesByNamespaceByRepoBranchByRevAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateSpacesByNamespaceByRepoBranchByRevAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateSpacesByNamespaceByRepoBranchByRevArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateSpacesByNamespaceByRepoBranchByRevSecurityRequirements,
                operationName: "CreateSpacesByNamespaceByRepoBranchByRevAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/spaces/{@namespace}/{repo}/branch/{rev}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateSpacesByNamespaceByRepoBranchByRevRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSpacesByNamespaceByRepoBranchByRev",
                                methodName: "CreateSpacesByNamespaceByRepoBranchByRevAsync",
                                pathTemplate: "$\"/api/spaces/{@namespace}/{repo}/branch/{rev}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSpacesByNamespaceByRepoBranchByRevResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateSpacesByNamespaceByRepoBranchByRevAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreateSpacesBranchRequest
            {
            ...
            await CreateSpacesByNamespaceByRepoBranchByRevAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                request: __request,
