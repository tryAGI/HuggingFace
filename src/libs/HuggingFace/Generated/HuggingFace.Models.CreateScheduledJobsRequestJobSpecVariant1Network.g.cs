...
namespace HuggingFace
{
    ...
    public sealed partial class CreateScheduledJobsRequestJobSpecVariant1Network
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScheduledJobsRequestJobSpecVariant1Network" /> class.
        /// </summary>
        /// <param name="group">
        /// Group name, scoped to the job's owner and resource group.
        /// </param>
...
#endif
        public CreateScheduledJobsRequestJobSpecVariant1Network(
            string group,
