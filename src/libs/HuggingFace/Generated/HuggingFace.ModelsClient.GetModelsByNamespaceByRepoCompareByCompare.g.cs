...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetModelsByNamespaceByRepoCompareByCompareSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetModelsByNamespaceByRepoCompareByCompareSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetModelsByNamespaceByRepoCompareByCompareSecurityRequirement0,
            };
        ...
        {
            var __response = await GetModelsByNamespaceByRepoCompareByCompareAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                compare: compare,
                raw: raw,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<string>> GetModelsByNamespaceByRepoCompareByCompareAsResponseAsync(
            string @namespace,
            string repo,
            string compare,
            object? raw = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetModelsByNamespaceByRepoCompareByCompareSecurityRequirements,
                operationName: "GetModelsByNamespaceByRepoCompareByCompareAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getModelsByNamespaceByRepoCompareByCompare",
                                methodName: "GetModelsByNamespaceByRepoCompareByCompareAsync",
                                pathTemplate: "$\"/api/models/{@namespace}/{repo}/compare/{compare}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
