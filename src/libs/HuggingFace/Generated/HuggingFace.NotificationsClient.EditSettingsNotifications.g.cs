...
namespace HuggingFace
{
    public partial class NotificationsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_EditSettingsNotificationsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_EditSettingsNotificationsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_EditSettingsNotificationsSecurityRequirement0,
            };
        ...
        {
            await EditSettingsNotificationsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> EditSettingsNotificationsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditSettingsNotificationsArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditSettingsNotificationsSecurityRequirements,
                operationName: "EditSettingsNotificationsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditSettingsNotificationsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editSettingsNotifications",
                                methodName: "EditSettingsNotificationsAsync",
                                pathTemplate: "\"/api/settings/notifications\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditSettingsNotificationsResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await EditSettingsNotificationsAsync(
                request: __request,
                requestOptions: requestOptions,
