...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateModelsByNamespaceByRepoUserAccessRequestGrantSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateModelsByNamespaceByRepoUserAccessRequestGrantSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateModelsByNamespaceByRepoUserAccessRequestGrantSecurityRequirement0,
            };
        partial void PrepareCreateModelsByNamespaceByRepoUserAccessRequestGrantArguments(
        ...
        public async global::System.Threading.Tasks.Task CreateModelsByNamespaceByRepoUserAccessRequestGrantAsync(
            string @namespace,
            string repo,
        ...
        {
            await CreateModelsByNamespaceByRepoUserAccessRequestGrantAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateModelsByNamespaceByRepoUserAccessRequestGrantAsResponseAsync(
            string @namespace,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateModelsByNamespaceByRepoUserAccessRequestGrantArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateModelsByNamespaceByRepoUserAccessRequestGrantSecurityRequirements,
                operationName: "CreateModelsByNamespaceByRepoUserAccessRequestGrantAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/models/{@namespace}/{repo}/user-access-request/grant",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateModelsByNamespaceByRepoUserAccessRequestGrantRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createModelsByNamespaceByRepoUserAccessRequestGrant",
                                methodName: "CreateModelsByNamespaceByRepoUserAccessRequestGrantAsync",
                                pathTemplate: "$\"/api/models/{@namespace}/{repo}/user-access-request/grant\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateModelsByNamespaceByRepoUserAccessRequestGrantResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await CreateModelsByNamespaceByRepoUserAccessRequestGrantAsync(
                @namespace: @namespace,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
