...
namespace HuggingFace
{
    ...
    public sealed partial class CreateBlogCommentReplyResponseNewMessageAuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBlogCommentReplyResponseNewMessageAuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreateBlogCommentReplyResponseNewMessageAuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
