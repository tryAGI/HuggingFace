...
namespace HuggingFace
{
    public partial class AgenticProvisioningClient
    {
        ...
        {
            var __response = await CreateAgenticProvisioningAccountRequestsAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createAgenticProvisioningAccountRequests",
                                methodName: "CreateAgenticProvisioningAccountRequestsAsync",
                                pathTemplate: "\"/api/agentic/provisioning/account_requests\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::HuggingFace.ApiException<global::HuggingFace.CreateAgenticProvisioningAccountRequestsResponse2>.Create(
