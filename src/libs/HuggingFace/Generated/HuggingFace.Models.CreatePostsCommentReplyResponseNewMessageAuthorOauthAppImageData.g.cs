...
namespace HuggingFace
{
    ...
    public sealed partial class CreatePostsCommentReplyResponseNewMessageAuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePostsCommentReplyResponseNewMessageAuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreatePostsCommentReplyResponseNewMessageAuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
