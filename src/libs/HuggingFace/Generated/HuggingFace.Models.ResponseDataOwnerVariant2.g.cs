...
namespace HuggingFace
{
    ...
    public sealed partial class ResponseDataOwnerVariant2
    {
        ...
        public global::HuggingFace.ResponseDataOwnerVariant2PrimaryOrg? PrimaryOrg { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseDataOwnerVariant2" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public ResponseDataOwnerVariant2(
            string id,
            string avatarUrl,
            string fullname,
            string name,
            ...
            global::HuggingFace.ResponseDataOwnerVariant2PrimaryOrg? primaryOrg,
            string type = "user")
        {
