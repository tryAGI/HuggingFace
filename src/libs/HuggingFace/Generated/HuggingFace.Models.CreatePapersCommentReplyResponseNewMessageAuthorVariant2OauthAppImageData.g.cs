...
namespace HuggingFace
{
    ...
    public sealed partial class CreatePapersCommentReplyResponseNewMessageAuthorVariant2OauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePapersCommentReplyResponseNewMessageAuthorVariant2OauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreatePapersCommentReplyResponseNewMessageAuthorVariant2OauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
