...
namespace HuggingFace
{
    public partial class DiscussionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreatePapersByPaperIdCommentSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreatePapersByPaperIdCommentSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreatePapersByPaperIdCommentSecurityRequirement0,
            };
        partial void PrepareCreatePapersByPaperIdCommentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string paperId,
            global::HuggingFace.CreatePapersCommentRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.CreatePapersCommentResponse> CreatePapersByPaperIdCommentAsync(
            string paperId,
        ...
        {
            var __response = await CreatePapersByPaperIdCommentAsResponseAsync(
                paperId: paperId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreatePapersCommentResponse>> CreatePapersByPaperIdCommentAsResponseAsync(
            string paperId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePapersByPaperIdCommentSecurityRequirements,
                operationName: "CreatePapersByPaperIdCommentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createPapersByPaperIdComment",
                                methodName: "CreatePapersByPaperIdCommentAsync",
                                pathTemplate: "$\"/api/papers/{paperId}/comment\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreatePapersCommentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreatePapersCommentResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreatePapersCommentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.CreatePapersCommentResponse> CreatePapersByPaperIdCommentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreatePapersCommentRequest
            {
                Comment = comment,
            };
