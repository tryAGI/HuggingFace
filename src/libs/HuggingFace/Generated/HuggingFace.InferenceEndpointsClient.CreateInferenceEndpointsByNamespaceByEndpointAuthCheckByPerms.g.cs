            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.CreateInferenceEndpointsAuthCheckResponse3.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.CreateInferenceEndpointsAuthCheckResponse3.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
