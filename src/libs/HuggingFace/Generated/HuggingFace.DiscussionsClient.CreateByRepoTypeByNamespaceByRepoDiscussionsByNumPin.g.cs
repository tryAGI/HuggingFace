...
namespace HuggingFace
{
    public partial class DiscussionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinSecurityRequirement0,
            };
        partial void PrepareCreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::HuggingFace.CreateDiscussionsPinRepoType repoType,
        ...
        {
            await CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinAsResponseAsync(
                repoType: repoType,
                @namespace: @namespace,
                repo: repo,
                num: num,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinAsResponseAsync(
            global::HuggingFace.CreateDiscussionsPinRepoType repoType,
            string @namespace,
            string repo,
            string num,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinSecurityRequirements,
                operationName: "CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/{(global::System.Uri.EscapeDataString(repoType.ToValueString()))}/{@namespace}/{repo}/discussions/{num}/pin",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createByRepoTypeByNamespaceByRepoDiscussionsByNumPin",
                                methodName: "CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinAsync",
                                pathTemplate: "$\"/api/{(global::System.Uri.EscapeDataString(repoType.ToValueString()))}/{@namespace}/{repo}/discussions/{num}/pin\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreateDiscussionsPinRequest
            {
                Pinned = pinned,
            };

            await CreateByRepoTypeByNamespaceByRepoDiscussionsByNumPinAsync(
                repoType: repoType,
                @namespace: @namespace,
                repo: repo,
                num: num,
