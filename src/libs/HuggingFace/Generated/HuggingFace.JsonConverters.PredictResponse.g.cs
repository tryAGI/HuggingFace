...
{
    /// <inheritdoc />
    public class PredictResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::HuggingFace.PredictResponse>
    {
        /// <inheritdoc />
        public override global::HuggingFace.PredictResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::HuggingFace.Prediction>), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::System.Collections.Generic.IList<global::HuggingFace.Prediction>>), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::System.Collections.Generic.IList<global::HuggingFace.Prediction>? predictResponseVariant1 = default;
            global::System.Collections.Generic.IList<global::System.Collections.Generic.IList<global::HuggingFace.Prediction>>? predictResponseVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        predictResponseVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        predictResponseVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (predictResponseVariant1 == null && predictResponseVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::HuggingFace.PredictResponse(
        ...
        public override void Write(
            ...
            global::HuggingFace.PredictResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsPredictResponseVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<global::HuggingFace.Prediction>), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::System.Collections.Generic.IList<global::HuggingFace.Prediction>?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::System.Collections.Generic.IList<global::HuggingFace.Prediction>).Name}");
