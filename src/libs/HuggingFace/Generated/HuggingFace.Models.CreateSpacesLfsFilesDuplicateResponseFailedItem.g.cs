...
namespace HuggingFace
{
    ...
    public sealed partial class CreateSpacesLfsFilesDuplicateResponseFailedItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSpacesLfsFilesDuplicateResponseFailedItem" /> class.
        /// </summary>
        /// <param name="xetHash">
        /// Xet content hash of the file that failed
        /// </param>
...
#endif
        public CreateSpacesLfsFilesDuplicateResponseFailedItem(
            string xetHash,
            string sha256,
            string error)
        {
