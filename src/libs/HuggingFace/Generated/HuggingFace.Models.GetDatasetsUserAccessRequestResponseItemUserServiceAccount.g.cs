...
namespace HuggingFace
{
    ...
    public sealed partial class GetDatasetsUserAccessRequestResponseItemUserServiceAccount
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDatasetsUserAccessRequestResponseItemUserServiceAccount" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetDatasetsUserAccessRequestResponseItemUserServiceAccount(
            string id,
            string org,
            string orgAvatarUrl,
            string? description)
