...
namespace HuggingFace
{
    ...
    public sealed partial class GetUsersFollowersResponseItemVariant1ServiceAccount
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsersFollowersResponseItemVariant1ServiceAccount" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetUsersFollowersResponseItemVariant1ServiceAccount(
            string id,
            string org,
            string orgAvatarUrl,
            string? description)
