...
namespace HuggingFace
{
    public partial class SpacesClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetSpacesSemanticSearchSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetSpacesSemanticSearchSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetSpacesSemanticSearchSecurityRequirement0,
            };
        partial void PrepareGetSpacesSemanticSearchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? q,
            ref global::HuggingFace.GetSpacesSemanticSearchCategory? category,
            ref bool? includeNonRunning,
            global::System.Collections.Generic.IList<global::HuggingFace.GetSpacesSemanticSearchSdkItem>? sdk,
            global::System.Collections.Generic.IList<string>? filter,
            ref bool? agents);
        partial void PrepareGetSpacesSemanticSearchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? q,
            global::HuggingFace.GetSpacesSemanticSearchCategory? category,
            bool? includeNonRunning,
            global::System.Collections.Generic.IList<global::HuggingFace.GetSpacesSemanticSearchSdkItem>? sdk,
            global::System.Collections.Generic.IList<string>? filter,
            bool? agents);
        partial void ProcessGetSpacesSemanticSearchResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetSpacesSemanticSearchAsync(
            string? q = default,
        ...
        {
            await GetSpacesSemanticSearchAsResponseAsync(
                q: q,
                category: category,
                includeNonRunning: includeNonRunning,
                sdk: sdk,
                filter: filter,
                agents: agents,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> GetSpacesSemanticSearchAsResponseAsync(
            string? q = default,
            global::HuggingFace.GetSpacesSemanticSearchCategory? category = default,
            bool? includeNonRunning = default,
            global::System.Collections.Generic.IList<global::HuggingFace.GetSpacesSemanticSearchSdkItem>? sdk = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSpacesSemanticSearchArguments(
                httpClient: HttpClient,
                q: ref q,
                category: ref category,
                includeNonRunning: ref includeNonRunning,
                sdk: sdk,
                filter: filter,
                agents: ref agents);
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetSpacesSemanticSearchSecurityRequirements,
                operationName: "GetSpacesSemanticSearchAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("includeNonRunning", includeNonRunning?.ToString().ToLowerInvariant())
                                .AddOptionalParameter("sdk", sdk, selector: static x => x.ToValueString(), delimiter: ",", explode: true)
                                .AddOptionalParameter("filter", filter, delimiter: ",", explode: true)
                                .AddOptionalParameter("agents", agents?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSpacesSemanticSearchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getSpacesSemanticSearch",
                                methodName: "GetSpacesSemanticSearchAsync",
                                pathTemplate: "\"/api/spaces/semantic-search\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSpacesSemanticSearchResponse(
                    httpClient: HttpClient,
