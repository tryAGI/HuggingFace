...
namespace HuggingFace
{
    ...
    public sealed partial class GetDiscussionsResponseVariant2EventVariant4AuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDiscussionsResponseVariant2EventVariant4AuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public GetDiscussionsResponseVariant2EventVariant4AuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
