...
namespace HuggingFace
{
    ...
    public sealed partial class CreatePostsCommentResponseNewMessageAuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePostsCommentResponseNewMessageAuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreatePostsCommentResponseNewMessageAuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
