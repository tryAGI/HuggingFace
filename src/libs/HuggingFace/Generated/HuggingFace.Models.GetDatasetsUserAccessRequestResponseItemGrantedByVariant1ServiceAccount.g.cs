...
namespace HuggingFace
{
    ...
    public sealed partial class GetDatasetsUserAccessRequestResponseItemGrantedByVariant1ServiceAccount
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDatasetsUserAccessRequestResponseItemGrantedByVariant1ServiceAccount" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public GetDatasetsUserAccessRequestResponseItemGrantedByVariant1ServiceAccount(
            string id,
            string org,
            string orgAvatarUrl,
            string? description)
