...
namespace HuggingFace
{
    public partial class NotificationsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_EditSettingsWatchSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_EditSettingsWatchSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_EditSettingsWatchSecurityRequirement0,
            };
        ...
        {
            await EditSettingsWatchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> EditSettingsWatchAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEditSettingsWatchArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditSettingsWatchSecurityRequirements,
                operationName: "EditSettingsWatchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditSettingsWatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editSettingsWatch",
                                methodName: "EditSettingsWatchAsync",
                                pathTemplate: "\"/api/settings/watch\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditSettingsWatchResponse(
                    httpClient: HttpClient,
