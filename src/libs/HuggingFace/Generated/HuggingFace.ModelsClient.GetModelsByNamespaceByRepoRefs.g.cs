...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetModelsByNamespaceByRepoRefsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetModelsByNamespaceByRepoRefsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetModelsByNamespaceByRepoRefsSecurityRequirement0,
            };
        partial void PrepareGetModelsByNamespaceByRepoRefsArguments(
        ...
        partial void ProcessGetModelsByNamespaceByRepoRefsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetModelsByNamespaceByRepoRefsAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetModelsByNamespaceByRepoRefsArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetModelsByNamespaceByRepoRefsSecurityRequirements,
                operationName: "GetModelsByNamespaceByRepoRefsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetModelsByNamespaceByRepoRefsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getModelsByNamespaceByRepoRefs",
                                methodName: "GetModelsByNamespaceByRepoRefsAsync",
                                pathTemplate: "$\"/api/models/{@namespace}/{repo}/refs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetModelsByNamespaceByRepoRefsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetModelsByNamespaceByRepoRefsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetModelsRefsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetModelsRefsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetModelsRefsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
