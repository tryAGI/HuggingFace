...
namespace HuggingFace
{
    ...
    public sealed partial class CreateScheduledJobsRequestJobSpecVariant2Network
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateScheduledJobsRequestJobSpecVariant2Network" /> class.
        /// </summary>
        /// <param name="group">
        /// Group name, scoped to the job's owner and resource group.
        /// </param>
...
#endif
        public CreateScheduledJobsRequestJobSpecVariant2Network(
            string group,
