            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_404 = await global::System.Text.Json.JsonSerializer.DeserializeAsync(__contentStream_404, typeof(string), JsonSerializerContext).ConfigureAwait(false) as string;
                    }
                }
