...
namespace HuggingFace
{
    public partial class ScimClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.Response23> GetOrganizationsByNameScimV2GroupsAsync(
            string name,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.Response23.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.Response23.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
