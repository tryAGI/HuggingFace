...
namespace HuggingFace
{
    public partial class DiscussionsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetByRepoTypeByNamespaceByRepoDiscussionsByNumSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetByRepoTypeByNamespaceByRepoDiscussionsByNumSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetByRepoTypeByNamespaceByRepoDiscussionsByNumSecurityRequirement0,
            };
        partial void PrepareGetByRepoTypeByNamespaceByRepoDiscussionsByNumArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::HuggingFace.GetDiscussionsRepoType2 repoType,
        ...
        partial void PrepareGetByRepoTypeByNamespaceByRepoDiscussionsByNumRequest(
            ...
            string repo,
            string num);
        partial void ProcessGetByRepoTypeByNamespaceByRepoDiscussionsByNumResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetByRepoTypeByNamespaceByRepoDiscussionsByNumResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetByRepoTypeByNamespaceByRepoDiscussionsByNumAsResponseAsync(
                repoType: repoType,
                @namespace: @namespace,
                repo: repo,
                num: num,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetByRepoTypeByNamespaceByRepoDiscussionsByNumArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetByRepoTypeByNamespaceByRepoDiscussionsByNumSecurityRequirements,
                operationName: "GetByRepoTypeByNamespaceByRepoDiscussionsByNumAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/{(global::System.Uri.EscapeDataString(repoType.ToValueString()))}/{@namespace}/{repo}/discussions/{num}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getByRepoTypeByNamespaceByRepoDiscussionsByNum",
                                methodName: "GetByRepoTypeByNamespaceByRepoDiscussionsByNumAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetByRepoTypeByNamespaceByRepoDiscussionsByNumResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetByRepoTypeByNamespaceByRepoDiscussionsByNumResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
