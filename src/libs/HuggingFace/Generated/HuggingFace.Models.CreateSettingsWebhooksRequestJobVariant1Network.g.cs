...
namespace HuggingFace
{
    ...
    public sealed partial class CreateSettingsWebhooksRequestJobVariant1Network
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSettingsWebhooksRequestJobVariant1Network" /> class.
        /// </summary>
        /// <param name="group">
        /// Group name, scoped to the job's owner and resource group.
        /// </param>
...
#endif
        public CreateSettingsWebhooksRequestJobVariant1Network(
            string group,
