...
namespace HuggingFace
{
    public partial class ServiceAccountsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensSecurityRequirement0,
            };
        partial void PrepareCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            ref string serviceAccountId,
            global::HuggingFace.CreateOrganizationsServiceAccountsTokensRequest request);
        partial void PrepareCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string name,
            string serviceAccountId,
            global::HuggingFace.CreateOrganizationsServiceAccountsTokensRequest request);
        partial void ProcessCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensAsResponseAsync(
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateOrganizationsServiceAccountsTokensResponse>> CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensAsResponseAsync(
            string name,
            string serviceAccountId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensSecurityRequirements,
                operationName: "CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createOrganizationsByNameServiceAccountsByServiceAccountIdTokens",
                                methodName: "CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensAsync",
                                pathTemplate: "$\"/api/organizations/{name}/service-accounts/{serviceAccountId}/tokens\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.CreateOrganizationsServiceAccountsTokensResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateOrganizationsServiceAccountsTokensResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.CreateOrganizationsServiceAccountsTokensResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.CreateOrganizationsServiceAccountsTokensResponse> CreateOrganizationsByNameServiceAccountsByServiceAccountIdTokensAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HuggingFace.CreateOrganizationsServiceAccountsTokensRequest
            {
