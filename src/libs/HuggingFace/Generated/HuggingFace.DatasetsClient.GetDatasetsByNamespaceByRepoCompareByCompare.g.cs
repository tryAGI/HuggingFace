...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetDatasetsByNamespaceByRepoCompareByCompareSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetDatasetsByNamespaceByRepoCompareByCompareSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetDatasetsByNamespaceByRepoCompareByCompareSecurityRequirement0,
            };
        partial void PrepareGetDatasetsByNamespaceByRepoCompareByCompareArguments(
        ...
        partial void ProcessGetDatasetsByNamespaceByRepoCompareByCompareResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetDatasetsByNamespaceByRepoCompareByCompareAsync(
            string @namespace,
            string repo,
            string compare,
            object? raw = default,
        ...
        {
            var __response = await GetDatasetsByNamespaceByRepoCompareByCompareAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                compare: compare,
                raw: raw,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<string>> GetDatasetsByNamespaceByRepoCompareByCompareAsResponseAsync(
            string @namespace,
            string repo,
            string compare,
            object? raw = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDatasetsByNamespaceByRepoCompareByCompareArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDatasetsByNamespaceByRepoCompareByCompareSecurityRequirements,
                operationName: "GetDatasetsByNamespaceByRepoCompareByCompareAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetDatasetsByNamespaceByRepoCompareByCompareRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDatasetsByNamespaceByRepoCompareByCompare",
                                methodName: "GetDatasetsByNamespaceByRepoCompareByCompareAsync",
                                pathTemplate: "$\"/api/datasets/{@namespace}/{repo}/compare/{compare}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDatasetsByNamespaceByRepoCompareByCompareResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDatasetsByNamespaceByRepoCompareByCompareResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
