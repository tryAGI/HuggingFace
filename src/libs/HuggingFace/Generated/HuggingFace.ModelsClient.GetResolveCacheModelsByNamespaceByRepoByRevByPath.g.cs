...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetResolveCacheModelsByNamespaceByRepoByRevByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetResolveCacheModelsByNamespaceByRepoByRevByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetResolveCacheModelsByNamespaceByRepoByRevByPathSecurityRequirement0,
            };
        ...
        {
            var __response = await GetResolveCacheModelsByNamespaceByRepoByRevByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveCacheModelsResponse>> GetResolveCacheModelsByNamespaceByRepoByRevByPathAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetResolveCacheModelsByNamespaceByRepoByRevByPathSecurityRequirements,
                operationName: "GetResolveCacheModelsByNamespaceByRepoByRevByPathAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getResolveCacheModelsByNamespaceByRepoByRevByPath",
                                methodName: "GetResolveCacheModelsByNamespaceByRepoByRevByPathAsync",
                                pathTemplate: "$\"/api/resolve-cache/models/{@namespace}/{repo}/{rev}/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetResolveCacheModelsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveCacheModelsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetResolveCacheModelsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
