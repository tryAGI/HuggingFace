...
namespace HuggingFace
{
    public partial class HuggingFaceInferenceClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_ChatCompletionsSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_ChatCompletionsSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.ChatCompletion> ChatCompletionsAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.ChatCompletion>> ChatCompletionsAsResponseAsync(
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.ChatCompletion.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.ChatCompletion>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.ChatCompletion.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
