...
namespace HuggingFace
{
    ...
    public sealed partial class GetOrganizationsScimProvisioningV2UsersResponseResourceName
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationsScimProvisioningV2UsersResponseResourceName" /> class.
        /// </summary>
...
#endif
        public GetOrganizationsScimProvisioningV2UsersResponseResourceName(
            string givenName,
            string familyName,
            string formatted)
        {
