...
namespace HuggingFace
{
    ...
    public sealed partial class GetDiscussionsResponseVariant2EventVariant5AuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDiscussionsResponseVariant2EventVariant5AuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public GetDiscussionsResponseVariant2EventVariant5AuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
