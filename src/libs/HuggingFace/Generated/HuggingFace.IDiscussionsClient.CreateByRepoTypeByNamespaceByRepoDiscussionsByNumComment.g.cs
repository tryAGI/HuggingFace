...
namespace HuggingFace
{
    public partial interface IDiscussionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.CreateDiscussionsCommentResponse>> CreateByRepoTypeByNamespaceByRepoDiscussionsByNumCommentAsResponseAsync(
            global::HuggingFace.CreateDiscussionsCommentRepoType repoType,
            string @namespace,
            string repo,
            string num,
