...
namespace HuggingFace
{
    ...
    {
        partial void PrepareGetByRepoTypeByNamespaceByRepoCommitsByRevArguments(
            ...
            ref int? limit);
        partial void PrepareGetByRepoTypeByNamespaceByRepoCommitsByRevRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::System.Collections.Generic.IList<global::HuggingFace.ExpandItem>? expand,
            int? limit);
        partial void ProcessGetByRepoTypeByNamespaceByRepoCommitsByRevResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetByRepoTypeByNamespaceByRepoCommitsByRevResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::HuggingFace.ResponseItem12>> GetByRepoTypeByNamespaceByRepoCommitsByRevAsync(
            global::HuggingFace.RepoType6 repoType,
            string @namespace,
            string repo,
            string rev,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetByRepoTypeByNamespaceByRepoCommitsByRevArguments(
            ...
            var __pathBuilder = new global::HuggingFace.PathBuilder(
                path: $"/api/{repoType}/{@namespace}/{repo}/commits/{rev}",
            ...
            PrepareGetByRepoTypeByNamespaceByRepoCommitsByRevRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetByRepoTypeByNamespaceByRepoCommitsByRevResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetByRepoTypeByNamespaceByRepoCommitsByRevResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
