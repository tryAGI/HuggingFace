...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetDatasetsByNamespaceByRepoTreesizeByRevByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetDatasetsByNamespaceByRepoTreesizeByRevByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetDatasetsByNamespaceByRepoTreesizeByRevByPathSecurityRequirement0,
            };
        ...
        {
            var __response = await GetDatasetsByNamespaceByRepoTreesizeByRevByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetDatasetsTreesizeResponse>> GetDatasetsByNamespaceByRepoTreesizeByRevByPathAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetDatasetsByNamespaceByRepoTreesizeByRevByPathSecurityRequirements,
                operationName: "GetDatasetsByNamespaceByRepoTreesizeByRevByPathAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getDatasetsByNamespaceByRepoTreesizeByRevByPath",
                                methodName: "GetDatasetsByNamespaceByRepoTreesizeByRevByPathAsync",
                                pathTemplate: "$\"/api/datasets/{@namespace}/{repo}/treesize/{rev}/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetDatasetsTreesizeResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetDatasetsTreesizeResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetDatasetsTreesizeResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
