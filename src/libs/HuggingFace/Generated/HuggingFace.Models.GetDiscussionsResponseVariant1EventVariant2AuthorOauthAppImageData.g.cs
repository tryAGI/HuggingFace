...
namespace HuggingFace
{
    ...
    public sealed partial class GetDiscussionsResponseVariant1EventVariant2AuthorOauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDiscussionsResponseVariant1EventVariant2AuthorOauthAppImageData" /> class.
        /// </summary>
...
#endif
        public GetDiscussionsResponseVariant1EventVariant2AuthorOauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
