...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CreateDatasetsByNamespaceByRepoAskAccessSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CreateDatasetsByNamespaceByRepoAskAccessSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CreateDatasetsByNamespaceByRepoAskAccessSecurityRequirement0,
            };
        partial void PrepareCreateDatasetsByNamespaceByRepoAskAccessArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string @namespace,
            ref string repo,
            object request);
        partial void PrepareCreateDatasetsByNamespaceByRepoAskAccessRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string @namespace,
            string repo,
            object request);
        partial void ProcessCreateDatasetsByNamespaceByRepoAskAccessResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateDatasetsByNamespaceByRepoAskAccessAsync(
            string @namespace,
            string repo,
        ...
        {
            await CreateDatasetsByNamespaceByRepoAskAccessAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse> CreateDatasetsByNamespaceByRepoAskAccessAsResponseAsync(
            string @namespace,
            string repo,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateDatasetsByNamespaceByRepoAskAccessArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDatasetsByNamespaceByRepoAskAccessSecurityRequirements,
                operationName: "CreateDatasetsByNamespaceByRepoAskAccessAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateDatasetsByNamespaceByRepoAskAccessRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createDatasetsByNamespaceByRepoAskAccess",
                                methodName: "CreateDatasetsByNamespaceByRepoAskAccessAsync",
                                pathTemplate: "$\"/datasets/{@namespace}/{repo}/ask-access\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateDatasetsByNamespaceByRepoAskAccessResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Redirection to the repo
                            if ((int)__response.StatusCode == 303)
                            {
                                string? __content_303 = null;
                                global::System.Exception? __exception_303 = null;
                                string? __value_303 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_303 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_303 = (string?)global::System.Text.Json.JsonSerializer.Deserialize(__content_303, typeof(string), JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_303 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await CreateDatasetsByNamespaceByRepoAskAccessAsync(
                @namespace: @namespace,
                repo: repo,
                request: __request,
                requestOptions: requestOptions,
