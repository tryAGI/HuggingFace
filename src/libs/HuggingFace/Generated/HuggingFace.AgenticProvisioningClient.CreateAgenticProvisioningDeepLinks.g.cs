            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_400 = global::HuggingFace.CreateAgenticProvisioningDeepLinksResponse2.FromJson(__content_400, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.CreateAgenticProvisioningDeepLinksResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.CreateAgenticProvisioningDeepLinksResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
