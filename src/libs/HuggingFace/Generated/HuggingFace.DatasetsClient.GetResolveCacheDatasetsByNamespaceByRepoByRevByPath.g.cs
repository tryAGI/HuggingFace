...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetResolveCacheDatasetsByNamespaceByRepoByRevByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetResolveCacheDatasetsByNamespaceByRepoByRevByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetResolveCacheDatasetsByNamespaceByRepoByRevByPathSecurityRequirement0,
            };
        partial void PrepareGetResolveCacheDatasetsByNamespaceByRepoByRevByPathArguments(
            ...
            ref string? range,
            ref string? accept);
        partial void PrepareGetResolveCacheDatasetsByNamespaceByRepoByRevByPathRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? range,
            string? accept);
        partial void ProcessGetResolveCacheDatasetsByNamespaceByRepoByRevByPathResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetResolveCacheDatasetsByNamespaceByRepoByRevByPathResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.GetResolveCacheDatasetsResponse> GetResolveCacheDatasetsByNamespaceByRepoByRevByPathAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
        ...
        {
            var __response = await GetResolveCacheDatasetsByNamespaceByRepoByRevByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveCacheDatasetsResponse>> GetResolveCacheDatasetsByNamespaceByRepoByRevByPathAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetResolveCacheDatasetsByNamespaceByRepoByRevByPathArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetResolveCacheDatasetsByNamespaceByRepoByRevByPathSecurityRequirements,
                operationName: "GetResolveCacheDatasetsByNamespaceByRepoByRevByPathAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::HuggingFace.PathBuilder(
                                path: $"/api/resolve-cache/datasets/{@namespace}/{repo}/{rev}/{path}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getResolveCacheDatasetsByNamespaceByRepoByRevByPath",
                                methodName: "GetResolveCacheDatasetsByNamespaceByRepoByRevByPathAsync",
                                pathTemplate: "$\"/api/resolve-cache/datasets/{@namespace}/{repo}/{rev}/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetResolveCacheDatasetsByNamespaceByRepoByRevByPathResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetResolveCacheDatasetsByNamespaceByRepoByRevByPathResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetResolveCacheDatasetsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveCacheDatasetsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetResolveCacheDatasetsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
