...
namespace HuggingFace
{
    public partial class DatasetsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.Response144> GetResolveCacheDatasetsByNamespaceByRepoByRevByPathAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.Response144.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.Response144.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
