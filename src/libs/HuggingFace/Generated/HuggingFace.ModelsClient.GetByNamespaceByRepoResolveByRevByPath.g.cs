...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_GetByNamespaceByRepoResolveByRevByPathSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_GetByNamespaceByRepoResolveByRevByPathSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_GetByNamespaceByRepoResolveByRevByPathSecurityRequirement0,
            };
        partial void PrepareGetByNamespaceByRepoResolveByRevByPathArguments(
            ...
            ref string? range,
            ref string? accept);
        partial void PrepareGetByNamespaceByRepoResolveByRevByPathRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? range,
            string? accept);
        partial void ProcessGetByNamespaceByRepoResolveByRevByPathResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetByNamespaceByRepoResolveByRevByPathResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.GetResolveResponse> GetByNamespaceByRepoResolveByRevByPathAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
        ...
        {
            var __response = await GetByNamespaceByRepoResolveByRevByPathAsResponseAsync(
                @namespace: @namespace,
                repo: repo,
                rev: rev,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HuggingFace.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveResponse>> GetByNamespaceByRepoResolveByRevByPathAsResponseAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetByNamespaceByRepoResolveByRevByPathArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetByNamespaceByRepoResolveByRevByPathSecurityRequirements,
                operationName: "GetByNamespaceByRepoResolveByRevByPathAsync");
            ...
            if (accept != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetByNamespaceByRepoResolveByRevByPathRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getByNamespaceByRepoResolveByRevByPath",
                                methodName: "GetByNamespaceByRepoResolveByRevByPathAsync",
                                pathTemplate: "$\"/{@namespace}/{repo}/resolve/{rev}/{path}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetByNamespaceByRepoResolveByRevByPathResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetByNamespaceByRepoResolveByRevByPathResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::HuggingFace.GetResolveResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::HuggingFace.AutoSDKHttpResponse<global::HuggingFace.GetResolveResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::HuggingFace.GetResolveResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
