...
namespace HuggingFace
{
    public partial class ModelsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::HuggingFace.Response136> GetByNamespaceByRepoResolveByRevByPathAsync(
            string @namespace,
            string repo,
            string rev,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::HuggingFace.Response136.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::HuggingFace.Response136.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
