...
namespace HuggingFace
{
    ...
    public sealed partial class CreatePapersCommentReplyResponseNewMessageAuthorVariant1OauthAppImageData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePapersCommentReplyResponseNewMessageAuthorVariant1OauthAppImageData" /> class.
        /// </summary>
...
#endif
        public CreatePapersCommentReplyResponseNewMessageAuthorVariant1OauthAppImageData(
            string emoji,
            string colorFrom,
            string colorTo)
        {
