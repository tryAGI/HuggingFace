...
namespace HuggingFace
{
    public partial class HuggingFaceInferenceClient
    {
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement s_CompatGenerateAsStreamSecurityRequirement0 =
        ...
        private static readonly global::HuggingFace.EndPointSecurityRequirement[] s_CompatGenerateAsStreamSecurityRequirements =
            new global::HuggingFace.EndPointSecurityRequirement[]
            {                s_CompatGenerateAsStreamSecurityRequirement0,
            };
        partial void PrepareCompatGenerateAsStreamArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::HuggingFace.CompatGenerateRequest request);
        partial void PrepareCompatGenerateAsStreamRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::HuggingFace.CompatGenerateRequest request);
        partial void ProcessCompatGenerateAsStreamResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::HuggingFace.StreamResponse> CompatGenerateAsStreamAsync(
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCompatGenerateAsStreamArguments(
            ...
            var __authorizations = global::HuggingFace.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CompatGenerateAsStreamSecurityRequirements,
                operationName: "CompatGenerateAsStreamAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCompatGenerateAsStreamRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HuggingFace.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CompatGenerateAsStream",
                                methodName: "CompatGenerateAsStreamAsync",
                                pathTemplate: "\"/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCompatGenerateAsStreamResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HuggingFace.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                                ...
                                .Create(__stream).EnumerateAsync(__effectiveCancellationToken))
                            {
                                ...
                                var __streamedResponse = global::HuggingFace.StreamResponse.FromJson(__content, JsonSerializerContext) ??
                                                       throw new global::HuggingFace.ApiException(
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __enumerable = CompatGenerateAsStreamAsync(
                request: __request,
                requestOptions: requestOptions,
                cancellationToken: cancellationToken);
